<script>
    ...
    // Receive scores as a prop
    export let scores = [0, 0, 0, 0, 0]
...
<!-- Main container for the chart and its header -->
    ...
    {#if !chartOnly}
        ...
        <div class="flex justify-between">
            <div class="">
                ...
                <p
                    class="max-w-screen-md text-base font-normal text-gray-500 pb-6"
                >
