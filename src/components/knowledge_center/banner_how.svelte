...
<div>
    <a
        use:link
        href="/knowledge-center/how-they-work"
        class="flex flex-col items-center bg-white border border-gray-300 rounded-lg shadow-md md:flex-row hover:bg-gray-50 h-full group"
    >
        <img
            class="object-cover w-full rounded-t-lg max-h-60 md:h-full md:rounded-none md:rounded-s-lg"
            src="/img/how_they_work.webp"
            alt="logo"
        />
